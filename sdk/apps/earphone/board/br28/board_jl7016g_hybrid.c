...
#if TCFG_EXTERNAL_TOUCH_KEY_ENABLE
/* 外置触摸和入耳检测的电源保持 */
    port_protect(port_group, TCFG_EXTERNAL_TOUCH_KEY_POWER_PORT);
    port_protect(port_group, TCFG_EXTERNAL_TOUCH_KEY_EN_PORT);
#endif

#if TCFG_EXTERN_STORAGE_MODE_ENABLE
/* BOAT_PL在softoff的时候也保持高,不然会触发模块断电 */
    port_protect(port_group, TCFG_EXTERN_STORAGE_MODE_BOAT_PL_PORT);
#endif
    ...
    port_protect(port_group, TCFG_EXTERNAL_TOUCH_KEY_POWER_PORT);//软关机KEEP外置触摸供电

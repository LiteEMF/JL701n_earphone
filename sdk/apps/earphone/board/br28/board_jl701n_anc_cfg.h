...
#elif (TCFG_SMART_VOICE_ENABLE || TCFG_AUDIO_ASR_DEVELOP || TCFG_CVP_DEVELOP_ENABLE || TCFG_AUDIO_ANC_EAR_ADAPTIVE_EN)
...
#if CLIENT_BOARD == CUSTOM5_CFG 	/*头戴式关闭TWS*/
